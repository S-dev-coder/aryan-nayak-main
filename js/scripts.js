...
(function ($) {
    ...
    jQuery(document).ready(function () {
       ...
       /* Mobile Navigation Hide or Collapse on Click */
        ...
        $(".typing").typed({
            strings: ["I am a Competitive Programmer.", "I build cool Websites." , "I am a Singer.", "I am a Dancer." ,"I am a Ms.fresher."],    /* You can change the home section typing text from
